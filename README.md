...
BackMIR 是一款仿热血传奇风格的 2D MMORPG，包含完整的客户端与服务端源码。本仓库参考 [sryanyuan](https://github.com/sryanyuan) 的原始代码，以开源存档形式发布。
...
本仓库以开源存档形式发布，代码质量参差不齐（原作者 [sryanyuan](https://github.com/sryanyuan) 自注：刚毕业时写的，现在看起来惨不忍睹）。欢迎提 Issue 或 PR。
